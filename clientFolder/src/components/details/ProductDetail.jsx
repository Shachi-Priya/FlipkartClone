...
const ProductDetail=({product})=>{
    ...
    return(
        <>
            ...
            <Typography style={{marginTop:5, color:"#878787", fonstSize:14}}>
                8 Ratings & 1 Reviews
            ...
            <SmallText>
                ...
                <Typography>
                    <StyledBadge/> Sign up for Flipkart Pay Later and get Flipkart Gift Card worth up to ₹500 Know More
                </Typography>
                <Typography>
                ...
                <Typography>
                    <StyledBadge/> No cost EMI on Bajaj Finserv EMI Card on cart value above ₹2999 T&C
                </Typography>
            </SmallText>
            <Table>
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            <Box component="span" style={{color:"#2873f0"}}>SuperComNet</Box>
